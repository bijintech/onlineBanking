...
<section class="banner-section style-two">
    <div class="banner-carousel owl-theme owl-carousel owl-dots-none">
        <div class="slide-item">
            ...
            <div class="auto-container">
                <div class="content-box">
                    ...
                    <h1>Because we care <br />  about your finincies </h1>
                    <p>Beniam quis nostrud exercitation sed lamco laboris nis aliquip <br />repraderit luptate velit excepteur ocaan ipsum.</p>
                    <div class="btn-box">
                        <a href="index.html" class="theme-btn style-two"><i class="fas fa-atom"></i>Open an account</a>
                        <a href="index-6.html" class="user-btn-two"><i class="far fa-user"></i>Learn More</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="slide-item">
            ...
            <div class="auto-container">
                <div class="content-box centred">
                    ...
                    <p>our banking system is designed specifically to <br /> help you grow finically  </p>
                    <div class="btn-box">
                        <a href="index.html" class="theme-btn style-two"><i class="fas fa-atom"></i>Open an account</a>
                        <a href="index-6.html" class="user-btn-two"><i class="far fa-user"></i>Learn More</a>
                    </div>
        ...
        <div class="slide-item">
            ...
            <div class="auto-container">
                <div class="content-box">
                    <h1> Easy, fee-free <br />banking for entrepreneurs</h1>
                    <p>All in one internet banking solution you would ever need.</p>
                    <div class="btn-box">
                        <a href="index.html" class="theme-btn style-two mar-0"><i class="fas fa-atom"></i>Get Started</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 content-column">
                <div id="content_block_three">
                    <div class="content-box">
                        ...
                        <div class="text">
                            <p> Alliance Bank is authorised and regulated by the Malta Financial Services Authority, Company registration No. C 50343. The Bank is a participant in the Depositor Compensation Scheme established under the laws of Malta. You should consider the relevant Terms and Conditions and any relevant information available at services-alliancebank.com when deciding whether to acquire, or to continue to hold, a product. </p>
                        </div>
                        <div class="inner-box">
                            <div class="row clearfix">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 single-column">
                <div class="single-item">
                    ...
                    <h3>6,000,000 Trusted Customers</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 single-column">
                <div class="single-item">
...
<section class="protect-form centred">
    <div class="auto-container">
        <div class="inner-box">
            <h2>You are our #1 Customer</h2>
            <h3>We can only achive greate heights with loyal and comitted customers like you</h3>
            <form action="http://azim.commonsupport.com/Fionca/index-2.html" method="post" class="zip-form">
                <div class="form-group clearfix">
                    <input type="text" name="zip" placeholder="Your Email Address" required="">
                    <button class="theme-btn style-two" type="submit"><i class="far fa-user"></i>Register</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <div id="content_block_five">
                    <div class="content-box">
                        <div class="sec-title light left">
                            ...
                            <p>Contact us today, our 24/7 customer service team is always available to attend to your questions and enquiry.</p>
                        </div>
                ...
                <div id="content_block_six">
                    <div class="content-box">
                        <div class="tabs-box">
                            <div class="tab-btn-box">
                                <ul class="tab-btns tab-buttons clearfix">
                                    <li class="tab-btn active-btn" data-tab="#tab-4">Contact Us</li>
                                </ul>
                            </div>
                            <div class="tabs-content">
                                        ...
                                        <form action="#" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="select-box">
                                                    <select class="wide">
                                                        <option data-display="Select">Select a reason</option>
