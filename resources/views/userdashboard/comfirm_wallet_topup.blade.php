                                    ...
                                    <div class="row">
                                       <div class="col-lg-12">
                                            <div class="alert alert-warning">
                                                <p>Please deposit the total sum of <b>${{ number_format($transaction->amount ) }}</b> equivalent to <b>{{ $transaction->coin_equivalent}}</b> {{ $currency->name  }} to the following information</p> 
                                            </div>
                                       </div>
                                       <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <form action="{{ route('walletTopupProof', $transaction->unique_id  ) }}" method="post" enctype="multipart/form-data">
                                                @csrf
